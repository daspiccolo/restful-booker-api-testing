...
Exploratory and automated API testing project for the Restful Booker API.
...
Endpoints tested:
MethodEndpointDescriptionGET/pingHealth checkGET/bookingGet all bookings — including filtersGET/booking/:idGet booking by IDPOST/authGenerate authentication tokenPOST/bookingCreate a new bookingPUT/booking/:idFull update of a bookingPATCH/booking/:idPartial update of a bookingDELETE/booking/:idDelete a booking
...
Result: 11 bugs documented — see BUG_REPORT.md
